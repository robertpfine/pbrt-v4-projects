...
SCENE_FILE="${SCENE_DIR}/rgbgrid_poc_XXXXXX.pbrt"
MEDIUM_FILE="${SCENE_DIR}/rgbgrid_medium_XXXXXX.pbrt"

# --- GENERATE MEDIUM ---
echo "Generating rgbgrid medium..."
python3 "${SCENE_DIR}/gen_rgbgrid_poc.py"
mv rgbgrid_medium_XXXXXX.pbrt "$MEDIUM_FILE"
