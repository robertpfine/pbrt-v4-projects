...
def write_foliage(placements, canonical_leaf, foliage_cfg, project_root, index=0):
    """
    ...
    definitions_path = os.path.join(
        project_root, 'scene_files', f'foliage_defs_{index}.pbrt'
    )
    ...
    return f'scene_files/foliage_{index}.pbrt'

# =============================================================================
# 7. run
# =============================================================================

def run(tree, foliage_cfg, project_root, index=0):
    """
    ...
    write_foliage(placements, canonical_leaf, foliage_cfg, project_root, index=index)
